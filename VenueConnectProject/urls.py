...
urlpatterns = [
    ...
    path('users/<int:userid>/bookings/', views.BookingsView.as_view(), name='bookings'),
    ...
    path('users/<userid>/advertisements/<ad_id>/make_booking/<venue_id>', views.MakeBookingView.as_view(), name='make_booking'),
